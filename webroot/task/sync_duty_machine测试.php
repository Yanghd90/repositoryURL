...
if ( $MACHINE_BRAND == "ZK_iclock660" && $DATABASE_TYPE == "access" ){
	...
	$query = "select SENSORID,USERID,format(CHECKTIME,'yyyy-mm-dd hh:nn:ss') as CHECKTIME1 from CHECKINOUT where format(CHECKTIME,'yyyy-MM-dd hh:nn:ss') > '2016-09-01 14:04:35' and format(CHECKTIME,'yyyy-MM-dd hh:nn:ss') < '2016-09-01 14:04:40' order by CHECKTIME desc";
